...
if TYPE_CHECKING:
    ...
    VLLM_MOE_DBO_UNWRAP: bool = False
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # Enable DBO MoE unwrapping for torch.compile integration
    "VLLM_MOE_DBO_UNWRAP": lambda: bool(int(os.getenv("VLLM_MOE_DBO_UNWRAP", "0"))),
